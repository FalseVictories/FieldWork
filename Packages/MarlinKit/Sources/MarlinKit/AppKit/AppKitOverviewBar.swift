...
public final class AppKitOverviewBar : NSView {
...
//                    }
    ...
    public override func setFrameSize(_ newSize: NSSize) {
        ...
        guard let sample, newSize.width > 0 else {
            return
        }
        
        framesPerPixel = UInt(sample.numberOfFrames / UInt64(newSize.width))
    }
